...
using Emse.KMSPortal.Data.EF.Context;
using Emse.KMSPortal.Data.EF.Repositories;
using System;
...
namespace Emse.KMSPortal.Data.EF.UnitOfWork
{
    ...
    {
        private readonly KMSPortalContext _dbContext;

        public EFUnitOfWork(KMSPortalContext dbContext)
        {
            Database.SetInitializer<KMSPortalContext>(null);
